...
namespace MOLPayXDKExample
{
	public partial class ViewController : UIViewController
	{
		...
		public override void ViewDidLoad()
		{
			...
			paymentDetails.Add(MOLPay.mp_bill_description, "description");
			paymentDetails.Add(MOLPay.mp_bill_name, "name");
			paymentDetails.Add(MOLPay.mp_bill_email, "email@email.com");
            ...
            //paymentDetails.Add(MOLPay.mp_preferred_token, "new");
